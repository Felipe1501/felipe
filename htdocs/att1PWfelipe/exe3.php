...
<?php
  echo" <div class='cabecalho'><img src='img/ESfigma.png' id='ESfigma'>
    ...
    $area = (3.14 * ($raio * $raio));
    $HIPOTENUSA = sqrt(($HTR * $HTR) + ($HTR2 * $HTR2));


    echo "<h4> O Valor da Área do Círculo é: </h4>".$area;
    echo "<h4> O Valor da Hipotenusa é: </h4>".$HIPOTENUSA;




    echo "<form action='exe3.html' method='post'>
