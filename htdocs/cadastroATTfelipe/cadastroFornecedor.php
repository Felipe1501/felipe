		...
		<div class="row">
			...
			<div class="col">
				<form action="#" method="POST">
				  <div class="mb-3">
					<label for="nome" class="form-label" required>Nome Representante</label>
					<input type="text" class="form-control" id="nome" name="nome">
				  </div>
				  <div class="mb-3">
					<label for="cnpj" class="form-label" required>CNPJ</label>
                    <input name="cnpj" class="form-control" type="text" id="cnpj" oninput="mascara(this, 'cnpj')"/>
				  </div>
                  	<div class="mb-3">
					<label for="empresa" class="form-label" required>Nome Empresa</label>
					<input type="text" class="form-control" id="empresa" name="empresa">
				  </div>
				  <div class="mb-3">
					<label for="produto" class="form-label" required>TIPO DE PRODUTO</label>
...
<?php
	...
	if(!empty($_POST))
	{
		...
		$conteudo = "$nome, $cnpj, $empresa, $produto, $endereco, $pais, $tel, $email,
";
